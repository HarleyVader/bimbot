module.exports = {
  OWNER_IDS: ["885961944413134849"], // Bot owner ID's
  ...
  DASHBOARD: {
    ...
    baseURL: "http://199.192.17.195:8080", // base url
    failureURL: "http://199.192.17.195:8080", // failure redirect url
  ...
  INTERACTIONS: {
    ...
    TEST_GUILD_ID: "899774419654803527", // Guild ID where the interactions should be registered. [** Test you commands here first **]
  },
  XP_SYSTEM: {
